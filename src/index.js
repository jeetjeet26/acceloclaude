...
function buildMcpServer() {
  ...
  registerQuoteTools(server, acceloClient);
  registerPurchaseTools(server, acceloClient);
  registerContributorTools(server, acceloClient);
  registerProgressionTools(server, acceloClient);
